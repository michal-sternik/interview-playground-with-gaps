		...
		(function () {
			...
			function scheduleRoot(root2, element) {
				root2.context === emptyContextObject &&
					(updateContainerImpl(root2.current, 2, element, root2, null, null),
					flushSyncWork$1());
			}
						...
						if ("number" === typeof workInProgress2.tag) {
							...
							workInProgress2 &&
								...
								("string" !== typeof debugStack &&
									(fiber._debugStack = debugStack =
										formatOwnerStack(debugStack)),
								"" !== debugStack && (info += "\n" + debugStack));
				...
				for (propName in clientObject)
					if (clientObject.hasOwnProperty(propName)) {
						...
						var maxLength = 120 - 2 * indent - propName.length - 2,
							clientPropValue = describeValue(
								clientObject[propName],
								maxLength,
							);
				...
				if (
					...
					content =
						null == type
							...
							: content +
								describeTextDiff("" + clientProps, void 0, indent + 1);
				return content;
			}
			...
			function describeNode(node, indent) {
				...
				if (6 === node.fiber.tag)
					...
					if (void 0 === node.serverProps) {
						debugInfo = indent;
						var maxLength =
								120 - 2 * debugInfo - serverComponentName.length - 2,
							content = "";
						for (propName in i)
			...
			function validateDOMNesting(childTag, ancestorInfo) {
				...
				ancestorInfo =
					String(!!parentInfo) + "|" + childTag + "|" + ancestorTag;
			...
			function validateTextNesting(childText, parentTag, implicitRootScope) {
				if (
					implicitRootScope ||
					isTagValidWithParent("#text", parentTag, false)
				)
					return true;
			...
			function markUpdateLaneFromFiberToRoot(sourceFiber, update, lane) {
				...
				for (
					var isHidden = false, parent = sourceFiber.return;
					null !== parent;
				)
			...
			function enqueueUpdate(fiber, update, lane) {
				...
				if ((executionContext & RenderContext) !== NoContext)
					return (
						...
						null === componentName2
							? (update.next = update)
							: ((update.next = componentName2.next),
								(componentName2.next = update)),
			...
			function enqueueCapturedUpdate(workInProgress2, capturedUpdate) {
				...
				if (
					null !== current2 &&
					((current2 = current2.updateQueue), queue === current2)
				) {
					var newFirst = null,
						newLast = null;
			...
			function renderWithHooks(
				...
				ignorePreviousDependencies =
					null !== current2 && current2.type !== workInProgress2.type;
				if (
			...
			function finishRenderingHooks(current2, workInProgress2) {
				...
				null === workInProgress2.dependencies
					...
					: (workInProgress2.dependencies._debugThenableState =
							thenableState$1);
				...
				null === current2 ||
					...
					null !== current2 &&
						checkIfContextChanged(current2) &&
			...
			function validateFragmentProps(element, fiber, returnFiber) {
				for (
					var keys = Object.keys(element.props), i = 0;
					i < keys.length;
					i++
				) {
					var key = keys[i];
			...
			function createChildReconciler(shouldTrackSideEffects) {
				...
				function updatePortal(returnFiber, current2, portal, lanes) {
					if (
						...
						return (
							(current2 = createFiberFromPortal(
								portal,
								returnFiber.mode,
								lanes,
							)),
				...
				function updateFragment(returnFiber, current2, fragment, lanes, key) {
					if (null === current2 || 7 !== current2.tag)
						return (
							(current2 = createFiberFromFragment(
								fragment,
								returnFiber.mode,
								lanes,
								key,
			...
			function updateClassComponent(
				...
				switch (shouldErrorImpl(workInProgress2)) {
					case false:
						var _instance = workInProgress2.stateNode,
							state = new workInProgress2.type(
				...
				if (null === workInProgress2.stateNode) {
					...
					"contextType" in Component &&
						null !== _instance &&
						(void 0 === _instance ||
							_instance.$$typeof !== REACT_CONTEXT_TYPE) &&
					...
					unresolvedOldProps || oldState !== oldContext || hasForceUpdate
						? ("function" === typeof newApiName &&
							...
							(lane =
								...
								? (foundWillUpdateName ||
										("function" !==
											typeof _instance.UNSAFE_componentWillMount &&
											"function" !== typeof _instance.componentWillMount) ||
										("function" === typeof _instance.componentWillMount &&
											_instance.componentWillMount(),
										"function" === typeof _instance.UNSAFE_componentWillMount &&
					...
					(null !== current2 &&
						...
						? ("function" === typeof unresolvedOldProps &&
							...
							(foundWillUpdateName =
								...
								? (oldContext ||
										("function" !==
											typeof _instance.UNSAFE_componentWillUpdate &&
											"function" !== typeof _instance.componentWillUpdate) ||
										("function" === typeof _instance.componentWillUpdate &&
			...
			function updateSuspenseComponent(
				...
				if (null === current2) {
					if (isHydrating) {
						JSCompiler_object_inline_componentStack_2453
							...
							: reuseSuspenseHandlerOnStack(workInProgress2);
						if (isHydrating) {
							var JSCompiler_object_inline_message_2450 =
								nextHydratableInstance;
							var JSCompiler_temp;
				...
				if (
					...
					if (didSuspend)
						...
						(JSCompiler_object_inline_digest_2451 =
							0 !== (renderLanes2 & current2.childLanes)),
					...
					return (
						...
						null === JSCompiler_object_inline_message_2450
							...
							: ((JSCompiler_temp =
								...
								(JSCompiler_object_inline_message_2450 = {
									baseLanes:
										JSCompiler_object_inline_message_2450.baseLanes |
										renderLanes2,
			...
			function checkScheduledUpdateOrContext(current2, renderLanes2) {
				...
				current2 = current2.dependencies;
				return null !== current2 && checkIfContextChanged(current2)
					? true
					: false;
			}
				...
				switch (workInProgress2.tag) {
						...
						a: if (
							...
							shouldConstruct(current2)
								? ((returnFiber = resolveClassComponentProps(
									...
									(workInProgress2.type = current2 =
										resolveFunctionForHotReloading(current2)),
							...
							if (void 0 !== current2 && null !== current2) {
								if (
									((prevSibling = current2.$$typeof),
									prevSibling === REACT_FORWARD_REF_TYPE)
								) {
									workInProgress2.tag = 11;
									workInProgress2.type = current2 =
										resolveForwardRefForHotReloading(current2);
							...
							if (prevState.isDehydrated)
								if (
									...
									switch (current2.nodeType) {
										...
										default:
											current2 =
												"HTML" === current2.nodeName
													? current2.ownerDocument.body
													: current2;
									}
									nextHydratableInstance = getNextHydratable(
										current2.firstChild,
						...
						return (
							...
							null === current2 &&
								...
								didSuspendOrErrorDEV ||
									...
									null !== prevSibling &&
										(buildHydrationDiffNode(workInProgress2, 0).serverProps =
											prevSibling)),
								(hydrationParentFiber = workInProgress2),
								(rootOrSingletonContext = true),
					...
					case 5:
						return (
							null === current2 &&
								...
								nextState &&
									(returnFiber &&
										warnNonHydratedInstance(workInProgress2, prevSibling),
									throwOnHydrationMismatch(workInProgress2))),
							pushHostContext(workInProgress2),
					...
					case 6:
						return (
							null === current2 &&
								...
								returnFiber &&
									(current2 &&
										warnNonHydratedInstance(workInProgress2, renderLanes2),
									throwOnHydrationMismatch(workInProgress2))),
							null
						);
					case 13:
					...
					case 31:
						return (
							...
							null === current2
								? ((current2 = mountWorkInProgressOffscreenFiber(
										returnFiber,
										renderLanes2,
									)),
									(current2.ref = workInProgress2.ref),
							...
							null === current2
								? ((prevSibling = peekCacheFromPool()),
									null === prevSibling &&
										...
										null !== prevState &&
											(prevSibling.pooledCacheLanes |= renderLanes2),
				...
				switch (workInProgress2.tag) {
					...
					case 3:
						...
						if (null === current2 || null === current2.child)
							popHydrationState(workInProgress2)
								...
								: null === current2 ||
									(current2.memoizedState.isDehydrated &&
					...
					case 5:
						...
						if (null !== current2 && null != workInProgress2.stateNode)
							...
							if (popHydrationState(workInProgress2))
								...
								workInProgress2.stateNode = current2;
								a: switch (
									(setInitialProperties(current2, renderLanes2, newProps),
									renderLanes2)
								) {
									case "button":
									case "input":
						...
						if (current2 && null != workInProgress2.stateNode)
							...
							if (popHydrationState(workInProgress2)) {
								...
								(_type = renderLanes2.ancestorInfo.current),
									...
									(current2 =
										getOwnerDocumentFromRootContainer(current2).createTextNode(
											newProps,
										)),
									(current2[internalInstanceKey] = workInProgress2),
									(workInProgress2.stateNode = current2);
					...
					case 13:
						...
						if (
							null === current2 ||
							(null !== current2.memoizedState &&
								null !== current2.memoizedState.dehydrated)
						) {
					...
					case 19:
						...
						if (null === returnFiber)
							...
							if (!newProps)
								if (
									((current2 = findFirstSuspended(returnFiber)),
									null !== current2)
								) {
									if (
										((workInProgress2.flags |= 128),
					...
					case 23:
						return (
							...
							null !== current2
								? (null !== current2.memoizedState) !== newProps &&
									(workInProgress2.flags |= 8192)
					...
					case 24:
						return (
							(renderLanes2 = null),
							null !== current2 &&
								(renderLanes2 = current2.memoizedState.cache),
				...
				switch (finishedWork.tag) {
					...
					case 22:
						...
						if (!flags) {
							...
							(offscreenSubtreeWasHidden = current2) &&
									...
									if (null === finishedWork.stateNode) {
										a: {
											...
											b: switch (flags) {
												case "title":
													hoistableRoot =
														root2.getElementsByTagName("title")[0];
													if (
														!hoistableRoot ||
															...
															if (
																...
																hoistableRoot.getAttribute("href") ===
																	...
																	hoistableRoot.getAttribute("crossorigin") ===
																		(null == current2.crossOrigin
																			? null
																			: current2.crossOrigin))
															) {
								...
								root2 !== flags
									? (null === root2
											? null !== current2.stateNode &&
												((current2 = current2.stateNode),
												current2.parentNode.removeChild(current2))
											: root2.count--,
										null === flags
											? mountHoistable(
													hoistableRoot,
			...
			function commitCachePassiveMountEffect(current2, finishedWork) {
				...
				null !== finishedWork.alternate &&
					(current2 = finishedWork.alternate.memoizedState.cache);
				finishedWork = finishedWork.memoizedState.cache;
				finishedWork !== current2 &&
					(retainCache(finishedWork),
					null != current2 && releaseCache(current2));
			}
			...
			function processRootScheduleInMicrotask() {
				...
				for (
					var currentTime = now$1(), prev = null, root2 = firstScheduledRoot;
					null !== root2;
				) {
					var next = root2.next,
			...
			function listenToNonDelegatedEvent(domEventName, targetElement) {
				...
				void 0 === listenerSet &&
					(listenerSet = targetElement[internalEventHandlersKey] =
						/* @__PURE__ */ new Set());
				...
				switch (tag) {
					...
					case "select":
						...
						null != tag
							...
							: null != props &&
								updateOptions(domElement, !!hasSrc, props, true);
						return;
					case "textarea":
						checkControlledValueProps("textarea", props);
						listenToNonDelegatedEvent("invalid", domElement);
			...
			function getLaneLabelMap() {
				for (
					var map = /* @__PURE__ */ new Map(), lane = 1, index = 0;
					31 > index;
					index++
				) {
							...
							if (
								...
								runWithPriority(queuedTarget.priority, function () {
									if (13 === nearestMounted.tag) {
										...
										null !== root2 &&
											scheduleUpdateOnFiber(root2, nearestMounted, lane);
					...
					if (!ownerHasKeyUseWarning[componentKey]) {
						...
						null != child &&
							...
							"number" === typeof child.tag
								...
								: "string" === typeof child.name &&
									(componentName2 = child.name),
							componentName2 &&
								(childOwnerAppendix =
									" It was passed a child from " + componentName2 + "."));
						runWithFiberInDEV(workInProgress2, function () {
							console.error(
			...
			overrideProps = function (fiber, path, value) {
				fiber.pendingProps = copyWithSetImpl(
					fiber.memoizedProps,
					path,
					0,
					value,
