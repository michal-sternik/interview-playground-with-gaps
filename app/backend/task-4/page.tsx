...
import { ArrowLeft, FileEdit, Database, RefreshCw } from "lucide-react";
...
export default function BackendTask4() {
  ...
  const applyPresetUpdate = (key: string, value: any) => {
    setUpdateKey(key);
    setUpdateValue(typeof value === "string" ? value : JSON.stringify(value));
  };
